...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/tuto_dynamic_cubemap
  TARGETDIR  = bin
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/tuto_dynamic_cubemap
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_dynamic_cubemap
  DEFINES   += 
  INCLUDES  += -I. -Isrc/gKit
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/debug/tuto_dynamic_cubemap
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_dynamic_cubemap
  DEFINES   += -DDEBUG
  INCLUDES  += -I. -Isrc/gKit
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/release/tuto_dynamic_cubemap
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_dynamic_cubemap
  DEFINES   += 
  INCLUDES  += -I. -Isrc/gKit
