...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/tp1_iehl
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tp1_iehl
  DEFINES   += -DDEBUG
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/tp1_iehl
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tp1_iehl
  DEFINES   += 
  INCLUDES  += -I. -Isrc/gKit
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/release/tp1_iehl
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tp1_iehl
  DEFINES   += 
  INCLUDES  += -I. -Isrc/gKit
...
$(OBJDIR)/rgbe.o: src/gKit/rgbe.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/tp1_iehl.o: src/tp1_iehl.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
