...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/tuto7_scene
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto7_scene
  DEFINES   += -DDEBUG
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/tuto7_scene
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto7_scene
  DEFINES   += 
  INCLUDES  += -I. -Isrc/gKit
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/debug/tuto7_scene
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto7_scene
  DEFINES   += -DDEBUG
  INCLUDES  += -I. -Isrc/gKit
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/release/tuto7_scene
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto7_scene
  DEFINES   += 
  INCLUDES  += -I. -Isrc/gKit
...
$(OBJDIR)/rgbe.o: src/gKit/rgbe.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/tuto7_scene.o: tutos/tuto7_scene.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
