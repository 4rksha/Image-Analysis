...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/tuto_ao
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_ao
  DEFINES   += -DDEBUG
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/tuto_ao
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_ao
  DEFINES   += 
  INCLUDES  += -I. -Isrc/gKit
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/release/tuto_ao
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_ao
  DEFINES   += 
  INCLUDES  += -I. -Isrc/gKit
...
$(OBJDIR)/rgbe.o: src/gKit/rgbe.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/tuto_ao.o: tutos/M2/tuto_ao.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
