...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/tuto_storage2
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_storage2
  DEFINES   += -DDEBUG
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/tuto_storage2
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_storage2
  DEFINES   += 
  INCLUDES  += -I. -Isrc/gKit
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/debug/tuto_storage2
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_storage2
  DEFINES   += -DDEBUG
  INCLUDES  += -I. -Isrc/gKit
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/release/tuto_storage2
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tuto_storage2
  DEFINES   += 
  INCLUDES  += -I. -Isrc/gKit
...
$(OBJDIR)/rgbe.o: src/gKit/rgbe.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/tuto_storage2.o: tutos/tuto_storage2.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
