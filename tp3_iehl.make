...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/tp3_iehl
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tp3_iehl
  DEFINES   += -DDEBUG
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/tp3_iehl
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tp3_iehl
  DEFINES   += 
  INCLUDES  += -I. -Isrc/gKit
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/release/tp3_iehl
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tp3_iehl
  DEFINES   += 
  INCLUDES  += -I. -Isrc/gKit
...
$(OBJDIR)/rgbe.o: src/gKit/rgbe.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/tp3_iehl.o: src/tp3_iehl.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
