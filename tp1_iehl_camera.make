...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/debug/tp1_iehl_camera
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tp1_iehl_camera
  DEFINES   += -DDEBUG
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/release/tp1_iehl_camera
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tp1_iehl_camera
  DEFINES   += 
  INCLUDES  += -I. -Isrc/gKit
...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/debug/tp1_iehl_camera
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tp1_iehl_camera
  DEFINES   += -DDEBUG
  INCLUDES  += -I. -Isrc/gKit
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/release/tp1_iehl_camera
  TARGETDIR  = bin
  TARGET     = $(TARGETDIR)/tp1_iehl_camera
  DEFINES   += 
  INCLUDES  += -I. -Isrc/gKit
...
$(OBJDIR)/rgbe.o: src/gKit/rgbe.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
$(OBJDIR)/tp1_iehl_camera.o: src/tp1_iehl_camera.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o "$@" -c "$<"
