...
PROJECTS := shader_kit image_viewer tp2 tp1_iehl tp1_iehl_camera tp3_iehl tuto1 tuto2 tuto3 tuto4 tuto5 tuto6 tuto7 tuto7_camera tuto8 tuto9 tuto9_texture1 tuto9_textures tuto9_buffers tuto10 tuto_transform tuto_pad tuto1GL tuto2GL tuto2GL_app tuto3GL tuto3GL_reflect tuto4GL tuto4GL_normals tuto5GL tuto5GL_sampler tuto5GL_samplers tuto5GL_multi tuto_draw_cubemap tuto_cubemap tuto_dynamic_cubemap tuto6GL tuto6GL_buffer tuto_framebuffer tuto_uniform_buffers tuto_storage tuto_storage_buffer tuto_storage_texture min_data tuto_vertex_compute mesh_viewer tuto_time tuto_mdi tuto_mdi_count tuto_stream tuto_is tuto_raytrace_fragment
...
tp1_iehl: 
	@echo "==== Building tp1_iehl ($(config)) ===="
	@${MAKE} --no-print-directory -C . -f tp1_iehl.make

tp1_iehl_camera: 
	@echo "==== Building tp1_iehl_camera ($(config)) ===="
	@${MAKE} --no-print-directory -C . -f tp1_iehl_camera.make

tp3_iehl: 
	@echo "==== Building tp3_iehl ($(config)) ===="
	@${MAKE} --no-print-directory -C . -f tp3_iehl.make
...
clean:
	...
	@${MAKE} --no-print-directory -C . -f tp1_iehl.make clean
	@${MAKE} --no-print-directory -C . -f tp1_iehl_camera.make clean
	@${MAKE} --no-print-directory -C . -f tp3_iehl.make clean
